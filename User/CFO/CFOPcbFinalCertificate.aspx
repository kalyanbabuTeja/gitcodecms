<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CFOPcbFinalCertificate.aspx.cs" Inherits="MeghalayaUIP.User.CFO.CFOPcbFinalCertificate" %>
...
Water Act and Air Act respectively).
                                ...
                                <%--M/S RI KALENG LIMESTONE MINE--%>    <%--Limestone Mineat at Ri Kaleng, Lynti Dkhar, Sohbar Sirdarship, East Khasi Hills--%>
                                <p>
                                    CONSENT is granted to
                                        <asp:Label ID="lblName" runat="server" Style="font-weight: bold;"></asp:Label>
                                    for operating a 2.05 Ha.<asp:Label runat="server" ID="lbldistrict"></asp:Label>
                                    District with production capacity 2,01,150 TPA andwith a Project cost of 22,00,000/- (Rupees Twenty Two Lakhs) only under the following terms and conditions:
                                </p>
                                ...
                                2. The Consent to Operate is valid for a period upto
                                         <asp:Label runat="server" ID="Date" Style="font-weight: bold;"></asp:Label>
                                    unless otherwise suspended or revoked Applicationfor renewal of Consent to Operate shall be made within 3 (Three) months from the date of expiry of this consent
order;
                                </p>
...
(a) Obtainingthe Consent by misrepresentation or failure to disclose fully all relevant facts;
(b) A change in any condition that require temporary or permanent reduction or elimination of the authorizeddischarge/emission;
                                </p>


                                <p>
                                    4. This Consent does not convey any property right in either real or personal property or any exclusive privileges, nor doesit authorizes any injury to private property or any invasion of personal rights, nor any infringement of Central State or
...
the height of which should not be less than 5 (five) metres when matured and at a spacing of 1 (One) metre should bemade around the mine;
                                </p>
                                ...
                                <div style="display: flex; justify-content: center; align-items: center;">
                                    <table border="1">
                                        <tr>
                                            ...
                                            <th>Concentration in Ambient Air (µg/m³)</th>
                                        </tr>
                                        <tr>
                                            <td rowspan="2">1</td>
                                            <td rowspan="2">SO2</td>
