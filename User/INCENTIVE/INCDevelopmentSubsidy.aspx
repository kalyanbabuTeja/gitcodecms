<%@ Page Title="" Language="C#" MasterPageFile="~/User/user.Master" AutoEventWireup="true" CodeBehind="INCDevelopmentSubsidy.aspx.cs" Inherits="MeghalayaUIP.User.INCENTIVE.INCDevelopmentSubsidy" %>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Development Subsidy</h4>
                                </div>
                                <div class="card-body">
                                    <!-- <h4 class="card-title">Personal Information</h4> -->

                                    <div class="row">
                                        <h5 class="card-title ml-4 mt-3">3.Development Subsidy</h5>
                                        <div class="col-md-12 d-flex">
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label class="col-lg-6 col-form-label">3.1 Name and address of the statutory body who granted permission/registration *</label>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label class="col-lg-6 col-form-label">3.2	Amount of charges billed *</label>
                                                    <div class="col-lg-6 d-flex">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label class="col-lg-6 col-form-label">3.3	Amount of charges paid </label>
                                                    <div class="col-lg-6 d-flex">
                                        ...
                                        <div class="col-md-12 d-flex">
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label class="col-lg-6 col-form-label">3.4 Name of Research & Development Organization from whom know-how procured *</label>
                                                    <div class="col-lg-6 d-flex">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label class="col-lg-6 col-form-label">3.5 Amount of charges billed *</label>
                                                    <div class="col-lg-6 d-flex">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label class="col-lg-6 col-form-label">3.6 Amount of charges paid *</label>
                                                    <div class="col-lg-6 d-flex">
                                        ...
                                        <div class="col-md-12 d-flex">
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label class="col-lg-6 col-form-label">3.7 Amount of subsidy claimed  </label>
                                                    <div class="col-lg-6 d-flex">
                                        ...
                                        <div class="col-md-12 d-flex">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <label class="col-lg-6 col-form-label">(i)	Copies of bills/Money Receipt in support of the actual payment made be enclosed.</label>
