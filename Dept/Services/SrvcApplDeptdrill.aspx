<%@ Page Title="" Language="C#" MasterPageFile="~/Dept/dept.Master" AutoEventWireup="true" CodeBehind="SrvcApplDeptdrill.aspx.cs" Inherits="MeghalayaUIP.Dept.Services.SrvcApplDeptdrill" %>
        ...
        <div class="content container-fluid">
            <div class="col-md-12 d-flex">
                ...
                <div class="card-header d-flex  justify-content-between">
                    <h4 class="card-title mt-1" style="font-size: 18px !important;"><b>Services Applications with Time Lines</b></h4>
                    <div class="col-md-1">
                ...
                <div class="col-md-12 d-flex row mb-3">
                    ...
                    <div class="col-md-2">Services Status</div>
                ...
                <div class="card" id="Prescrutinycompleted" runat="server" visible="false">
                    ...
                    <section id="dashboardcount6" class="mt-3 mb-3">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                    <a href="SrvcApplDeptView.aspx?status=PRESCRUTINYCOMPLETED">
                                        <div class="card 1">
            ...
            <div class="card" id="PrescrutinyPending" runat="server" visible="false">
                ...
                <section id="dashboardcount7" class="mt-3 mb-3">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=PRESCRUTINYPENDING">
                                    <div class="card 1">
                                        <div class="card-headr">
                                            <div class="text">Total</div>
                                            <div class="iocn"><i class="fi fi-tr-memo-circle-check"></i></div>
                            ...
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=PRESCRUTINYPENDINGWITHIN">
                                    <div class="card 2">
                                        <div class="card-headr">
                                            <div class="text">Within Time Limits</div>
                                            <div class="iocn"><i class="fi fi-tr-file-download"></i></div>
                            ...
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=PRESCRUTINYPENDINGBEYOND">
                                    <div class="card 4">
                                        <div class="card-headr">
                                            <div class="text">Beyondin Time Limits</div>
                                            <div class="iocn"><i class="fi fi-tr-file-upload"></i></div>
            ...
            <div class="card" id="PreScrutinyRejected" runat="server" visible="false">
                ...
                <section id="dashboardcount8" class="mt-3 mb-3">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=PREREJECTED">
                                    <div class="card 1">
                                        <div class="card-headr">
                                            <div class="text">Total</div>
                                            <div class="iocn"><i class="fi fi-tr-memo-circle-check"></i></div>
                            ...
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=PREREJECTEDWITHIN">
                                    <div class="card 2">
                                        <div class="card-headr">
                                            <div class="text">Within Time Limits</div>
                                            <div class="iocn"><i class="fi fi-tr-file-download"></i></div>
                            ...
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=PREREJECTEDBEYOND">
                                    <div class="card 4">
                                        <div class="card-headr">
                                            <div class="text">Beyondin Time Limits</div>
                                            <div class="iocn"><i class="fi fi-tr-file-upload"></i></div>
            ...
            <div class="card" id="Approvalunderprocess" runat="server" visible="false">
                ...
                <section id="dashboardcount9" class="mt-3 mb-3">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=APPROVALPENDING">
                                    <div class="card 1">
                                        <div class="card-headr">
                                            <div class="text">Total</div>
                                            <div class="iocn"><i class="fi fi-tr-memo-circle-check"></i></div>
                            ...
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=APPROVALPENDINGWITHIN">
                                    <div class="card 2">
                                        <div class="card-headr">
                                            <div class="text">Within Time Limits</div>
                                            <div class="iocn"><i class="fi fi-tr-file-download"></i></div>
                            ...
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=APPROVALPENDINGBEYOND">
                                    <div class="card 4">
                                        <div class="card-headr">
                                            <div class="text">Beyondin Time Limits</div>
                                            <div class="iocn"><i class="fi fi-tr-file-upload"></i></div>
            ...
            <div class="card" id="ApprovalIssued" runat="server" visible="false">
                ...
                <section id="dashboardcount3" class="mt-3 mb-3">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=TOTALAPPROVALISSUED">
                                    <div class="card 1">
                                        <div class="card-headr">
                                            <div class="text">Total</div>
                                            <div class="iocn"><i class="fi fi-tr-memo-circle-check"></i></div>
                            ...
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=APPROVALISSUEDWITHIN">
                                    <div class="card 2">
                                        <div class="card-headr">
                                            <div class="text">Within Time Limits</div>
                                            <div class="iocn"><i class="fi fi-tr-file-download"></i></div>
                            ...
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=APPROVALISSUEDBEYOND">
                                    <div class="card 4">
                                        <div class="card-headr">
                                            <div class="text">Beyondin Time Limits</div>
                                            <div class="iocn"><i class="fi fi-tr-file-upload"></i></div>
            ...
            <div class="card" id="ApprovalRejected" runat="server" visible="false">
                ...
                <section id="dashboardcount10" class="mt-3 mb-3">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=REJECTED">
                                    <div class="card 1">
                                        <div class="card-headr">
                                            <div class="text">Total</div>
                                            <div class="iocn"><i class="fi fi-tr-memo-circle-check"></i></div>
                            ...
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=REJECTEDWITHIN">
                                    <div class="card 2">
                                        <div class="card-headr">
                                            <div class="text">Within Time Limits</div>
                                            <div class="iocn"><i class="fi fi-tr-file-download"></i></div>
                            ...
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=REJECTEDBEYOND">
                                    <div class="card 4">
                                        <div class="card-headr">
                                            <div class="text">Beyondin Time Limits</div>
                                            <div class="iocn"><i class="fi fi-tr-file-upload"></i></div>
            ...
            <div class="card" id="OfflineApprovalPending" runat="server" visible="false">
                ...
                <section id="dashboardcount11" class="mt-3 mb-3">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=OFFLINEPENDING">
                                    <div class="card 1">
                                        <div class="card-headr">
                                            <div class="text">Total</div>
                                            <div class="iocn"><i class="fi fi-tr-memo-circle-check"></i></div>
                            ...
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=OFFLINEPENDINGWITHIN">
                                    <div class="card 2">
                                        <div class="card-headr">
                                            <div class="text">Within Time Limits</div>
                                            <div class="iocn"><i class="fi fi-tr-file-download"></i></div>
                            ...
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=OFFLINEPENDINGBEYOND">
                                    <div class="card 4">
                                        <div class="card-headr">
            ...
            <div class="card" id="OfflineApproved" runat="server" visible="false">
                ...
                <section id="dashboardcount4" class="mt-3 mb-3">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=OFFLINEAPPROVED">
                                    <div class="card 1">
                                        <div class="card-headr">
                                            <div class="text">Total</div>
                                            <div class="iocn"><i class="fi fi-tr-memo-circle-check"></i></div>
                            ...
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=OFFLINEAPPROVEDWITHIN">
                                    <div class="card 2">
                                        <div class="card-headr">
                                            <div class="text">Within Time Limits</div>
                                            <div class="iocn"><i class="fi fi-tr-file-download"></i></div>
                            ...
                            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                                <a href="SrvcApplDeptView.aspx?status=OFFLINEAPPROVEDBEYOND">
                                    <div class="card 4">
                                        <div class="card-headr">
                                            <div class="text">Beyond in Time Limits</div>
                                            <div class="iocn"><i class="fi fi-tr-file-upload"></i></div>
