<%@ Page Title="" Language="C#" MasterPageFile="~/Dept/dept.Master" AutoEventWireup="true" CodeBehind="PreRegDITView.aspx.cs" Inherits="MeghalayaUIP.Dept.PreReg.PreRegDITView" %>
        ...
        <div class="content container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <asp:GridView ID="GVDIT" runat="server" AutoGenerateColumns="False" BorderColor="#003399" ShowHeaderWhenEmpty="true"
                        BorderStyle="Solid" BorderWidth="1px" CellPadding="4" CssClass="table-bordered mb-0 GRD" ForeColor="#333333"
                        GridLines="None" OnRowDataBound="GVDIT_RowDataBound" OnRowCommand="GVDIT_RowCommand"
